...
# function to generate random male_first_name
def m_fname ():
    return (fake.name_male().split()[0])

# function to generate random username
def username():
    return fake.first_name()+'_'+fake.last_name()

# function to generate random company
def comapny():
    return fake.company()

# function to generate random ip address v4
def ipv4():
    return fake.ipv4()
...
# function to generate random job
def job():
    return fake.job()
...
# function to domain name
def domain ():
    return 'www.' + random.choice(domain_name) + ".com"

# function to currency symbol
def symbol ():
    return random.choice(currency_symbol)
...
#function to make some values empty
def empty(df, percent):
    percent = int(percent)/100
    df1 = df.sample(frac= percent)
    df1.iloc[:, 0] ='NaN'
    df2 = df
